...
export const contentPosts = mysqlTable("content_posts", {
  ...
  status: mysqlEnum("status", ["draft", "review", "approved", "scheduled", "published", "rejected"]).default("draft").notNull(),
...
export const appUsers = mysqlTable("app_users", {
  ...
  subscriptionBilling: mysqlEnum("subscriptionBilling", ["monthly", "yearly"]).default("monthly").notNull(),
