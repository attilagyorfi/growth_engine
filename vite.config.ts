...
// NOTE: ne használjunk PROJECT_ROOT-et — az csak Node 20.11+-tól elérhető,
// és bundle-elt production kódban Node 18 alatt undefined → path.join crash.
// fileURLToPath + dirname minden Node verzión működik (Node 12+).
