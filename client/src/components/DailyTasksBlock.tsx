 ...
 * Meghívja a dailyTasks.generate mutation-t és megjelenít 3-5 teendőt kártyákon.
 */
import { useState } from "react";
import { trpc } from "@/lib/trpc";
import { toast } from "sonner";
import { Sparkles, RefreshCw, ArrowRight, CheckCircle2, Loader2 } from "lucide-react";
import { useLocation } from "wouter";
import { motion, AnimatePresence } from "framer-motion";

interface Task {
  text: string;
  category: "tartalom" | "lead" | "stratégia" | "kampány" | "egyéb";
  link: string;
}
      ...
      >
        ...
        >
          {isLoading ? (
            ...
            <RefreshCw size={12} className={generated ? "animate-none" : ""} />
          )}
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2 flex-shrink-0">
                        ...
                        {task.link && (
                          <ArrowRight size={12} style={{ color: "oklch(0.45 0.015 240)" }} />
                        )}
                      </div>
                    </motion.button>
                  );
